...
{
    ASSERT_EQ(0, strcmp(test_str, test_string_->string_data));
    ASSERT_EQ(strlen(test_str), test_string_->size);
}

TEST_F(CStringTest, Insert0)
{
    string_insert(test_string_, 0, 'K');
    ASSERT_EQ(0, strcmp("KTest", test_string_->string_data));
    ASSERT_EQ(strlen(test_str) + 1, test_string_->size);
}

TEST_F(CStringTest, Insert1)
{
    string_insert(test_string_, 1, 'K');
    ASSERT_EQ(0, strcmp("TKest", test_string_->string_data));
    ASSERT_EQ(strlen(test_str) + 1, test_string_->size);
}
...
TEST_F(CStringTest, Insert2)
{
    ...
    ASSERT_EQ(0, strcmp("TeKst", test_string_->string_data));
    ASSERT_EQ(strlen(test_str) + 1, test_string_->size);
}
...
TEST_F(CStringTest, Insert3)
{
    ...
    ASSERT_EQ(0, strcmp("TesKt", test_string_->string_data));
    ASSERT_EQ(strlen(test_str) + 1, test_string_->size);
}
...
TEST_F(CStringTest, Insert4)
{
    ...
    ASSERT_EQ(0, strcmp("TestK", test_string_->string_data));
    ASSERT_EQ(strlen(test_str) + 1, test_string_->size);
}
...
TEST_F(CStringTest, InsertOutOfBound)
{
    ...
    ASSERT_EQ(0, strcmp("Test", test_string_->string_data));
    ASSERT_EQ(strlen(test_str), test_string_->size);
}
...
TEST_F(CStringTest, InsertStr)
{
    ...
    ASSERT_EQ(0, strcmp("MeTest", test_string_->string_data));
    ASSERT_EQ(strlen(test_str) + 2, test_string_->size);
}

TEST_F(CStringTest, InsertStrEnd)
{
    ASSERT_EQ(0, string_insert_str(test_string_, 4, (char*) "Me"));
    ASSERT_EQ(0, strcmp("TestMe", test_string_->string_data));
    ASSERT_EQ(strlen(test_str) + 2, test_string_->size);
}
